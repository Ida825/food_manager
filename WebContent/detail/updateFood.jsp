				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
                    	<tr>   
							<td width="80px">菜系</td>
							<td>
							<jsp:useBean id="myFoodType" class="cn.et.model.MyFoodType"></jsp:useBean>
                            <select name="typeid" style="width:80px">
	                            <c:forEach var="ls" items="${pageScope.myFoodType.allFoodType}">
			   						<option value="${pageScope.ls.TYPEID }"  
			   							<c:if test="${param.typeid==pageScope.ls.TYPEID }">selected="selected"</c:if>
			   						>${ pageScope.ls.TYPENAME}</option>
			   					</c:forEach>	
						...
						<tr>
							<td>简介</td>
							<td><textarea name="descr" class="TextareaStyle"></textarea></td>
						</tr>
						...
						<tr>
							...
							<td>
									...
									src="${pageContext.request.contextPath}/showImage?imgName=${param.img}">
